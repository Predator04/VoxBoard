...
import com.voxboard.lib.ValidationRule
import org.voxboard.lib.snygg.SnyggStylesheet
import com.voxboard.lib.validate
import org.voxboard.lib.snygg.value.SnyggVarValue
...
object ExtensionValidation {
    ...
    val SnyggStaticColorValue = ValidationRule<String> {
        forKlass = org.voxboard.lib.snygg.value.SnyggStaticColorValue::class
        forProperty = "color"
        validator { input ->
            val str = input.trim()
            when {
                str.isBlank() -> resultInvalid(error = R.string.ext__validation__enter_color)
                org.voxboard.lib.snygg.value.SnyggStaticColorValue.deserialize(str).isFailure -> {
    ...
    val SnyggDpShapeValue = ValidationRule<String> {
        forKlass = org.voxboard.lib.snygg.value.SnyggDpShapeValue::class
        forProperty = "corner"
        validator { str ->
    ...
    val SnyggPercentShapeValue = ValidationRule<String> {
        forKlass = org.voxboard.lib.snygg.value.SnyggPercentShapeValue::class
        forProperty = "corner"
        validator { str ->
