...
package com.voxboard.lib.crashutility
...
import com.voxboard.lib.devtools.Devtools
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val versionName = buildString {
            ...
            if (BuildConfig.DEBUG) {
                append(stringRes(R.string.voxboard__commit_by_hash_url, "hash" to BuildConfig.BUILD_COMMIT_HASH))
            } else {
                append(stringRes(R.string.voxboard__changelog_url, "version" to BuildConfig.VERSION_NAME))
            }
            append(")")
        }
        errorReport.apply {
        ...
        openBugReportForm.setOnClickListener {
            val browserIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse(resources.getString(R.string.voxboard__issue_tracker_url))
            )
