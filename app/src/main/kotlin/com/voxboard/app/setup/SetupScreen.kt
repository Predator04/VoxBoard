...
package com.voxboard.app.setup
...
import com.voxboard.lib.compose.FlorisScreenScope
...
import org.voxboard.lib.compose.FlorisBulletSpacer
import org.voxboard.lib.compose.FlorisStep
import org.voxboard.lib.compose.FlorisStepLayout
import org.voxboard.lib.compose.FlorisStepState
...
private fun footer(context: Context) {
    ...
    Row(
        ...
        val privacyPolicyUrl = stringRes(R.string.voxboard__privacy_policy_url)
        TextButton(onClick = { context.launchUrl(privacyPolicyUrl) }) {
            Text(text = stringRes(R.string.setup__footer__privacy_policy))
        }
        FlorisBulletSpacer()
        val repositoryUrl = stringRes(R.string.voxboard__repo_url)
