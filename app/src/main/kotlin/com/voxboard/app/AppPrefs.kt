...
import com.voxboard.app.settings.theme.ColorPreferenceSerializer
import com.voxboard.app.settings.theme.DisplayKbdAfterDialogs
import com.voxboard.app.settings.theme.SnyggLevel
import com.voxboard.app.setup.NotificationPermissionState
...
import com.voxboard.ime.input.CapitalizationBehavior
import com.voxboard.ime.input.HapticVibrationMode
import com.voxboard.ime.input.InputFeedbackActivationMode
import com.voxboard.ime.keyboard.IncognitoMode
import com.voxboard.ime.keyboard.SpaceBarMode
import com.voxboard.ime.landscapeinput.LandscapeInputUiMode
import com.voxboard.ime.media.emoji.EmojiHairStyle
import com.voxboard.ime.media.emoji.EmojiHistory
import com.voxboard.ime.media.emoji.EmojiSkinTone
import com.voxboard.ime.media.emoji.EmojiSuggestionType
import com.voxboard.ime.nlp.SpellingLanguageMode
import com.voxboard.ime.onehanded.OneHandedMode
import com.voxboard.ime.smartbar.CandidatesDisplayMode
import com.voxboard.ime.smartbar.ExtendedActionsPlacement
import com.voxboard.ime.smartbar.IncognitoDisplayMode
import com.voxboard.ime.smartbar.SmartbarLayout
import com.voxboard.ime.smartbar.quickaction.QuickAction
import com.voxboard.ime.smartbar.quickaction.QuickActionArrangement
import com.voxboard.ime.smartbar.quickaction.QuickActionJsonConfig
import com.voxboard.ime.text.gestures.SwipeAction
import com.voxboard.ime.text.key.KeyCode
import com.voxboard.ime.text.key.KeyHintConfiguration
...
import com.voxboard.ime.theme.extCoreTheme
import com.voxboard.lib.ext.ExtensionComponentName
import com.voxboard.lib.observeAsTransformingState
import com.voxboard.lib.util.VersionName
import com.voxboard.jetpref.datastore.annotations.Preferences
import com.voxboard.jetpref.datastore.jetprefDataStoreOf
import com.voxboard.jetpref.datastore.model.LocalTime
import com.voxboard.jetpref.datastore.model.PreferenceData
import com.voxboard.jetpref.datastore.model.PreferenceMigrationEntry
import com.voxboard.jetpref.datastore.model.PreferenceModel
import com.voxboard.jetpref.datastore.model.PreferenceType
...
import org.voxboard.lib.android.isOrientationPortrait
import org.voxboard.lib.color.DEFAULT_GREEN
...
abstract class FlorisPreferenceModel : PreferenceModel() {
    companion object {
        const val NAME = "voxboard-app-prefs"
    }
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    com.voxboard.ime.media.emoji.Emoji(it, "", emptyList())
                }
