...
import com.voxboard.ime.keyboard.DefaultComputingEvaluator
import com.voxboard.ime.keyboard.Key
import com.voxboard.ime.keyboard.KeyData
import com.voxboard.ime.keyboard.Keyboard
import com.voxboard.ime.keyboard.KeyboardMode
import com.voxboard.ime.keyboard.computeImageVector
import com.voxboard.ime.keyboard.computeLabel
...
import org.voxboard.lib.snygg.SnyggAttributes
...
import org.voxboard.lib.snygg.ui.NonNullSaver
            ...
            AnimatedVisibility(visible = showKeyCodesHelp) {
                Column(modifier = Modifier.padding(bottom = 16.dp)) {
                    ...
                    FlorisHyperlinkText(
                        ...
                        url = stringRes(R.string.voxboard__character_key_codes_url),
                    )
                    FlorisHyperlinkText(
                        text = "Internal (github.com)",
                        url = stringRes(R.string.voxboard__internal_key_codes_url),
                    )
                }
            }
