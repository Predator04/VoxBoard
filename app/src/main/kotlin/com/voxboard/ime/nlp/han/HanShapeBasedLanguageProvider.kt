...
package com.voxboard.ime.nlp.han
...
import com.voxboard.ime.nlp.BreakIteratorGroup
import com.voxboard.ime.nlp.LanguagePackComponent
...
class HanShapeBasedLanguageProvider(val context: Context) : SpellingProvider, SuggestionProvider {
    companion object {
        ...
        const val ProviderId = "org.voxboard.nlp.providers.han.shape"
