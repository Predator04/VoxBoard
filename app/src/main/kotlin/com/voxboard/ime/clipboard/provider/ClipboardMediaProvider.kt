...
package com.voxboard.ime.clipboard.provider
...
class ClipboardMediaProvider : ContentProvider() {
    ...
    override fun getType(uri: Uri): String? {
        return when (Matcher.match(uri)) {
            ...
            IMAGE_CLIPS_TABLE -> "${ContentResolver.CURSOR_DIR_BASE_TYPE}/vnd.voxboard.image_clip_table"
            VIDEO_CLIPS_TABLE -> "${ContentResolver.CURSOR_DIR_BASE_TYPE}/vnd.voxboard.video_clip_table"
            else -> null
        }
    }
